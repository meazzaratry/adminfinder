...
system('cls');
system('Admin dot Finder By ju4ns1mon666 From ./n0th1ngs');
system "color 0a";
print"\n";
print "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\t>           Admin dot Finder               >\n";
print "\t>      By ju4ns1mon666 From ./n0th1ngs      >\n";
print "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\n";

print " Please Enter Site\n Example: www.target.com or www.target.com/path\n-> ";
$site=<STDIN>;
chomp $site;
